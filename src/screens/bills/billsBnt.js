...
export default class billsBnt extends PureComponent{
    constructor(props){
        super(props)
        this.state={
            sex: 'Male',
                ...
                <ScrollView>
                    <View style={styles.container}>                            
                        <View style={styles.decideview}>
                            ...
                            >
                                <Text style={styles.txtbnt}> PHCN EKO </Text>
                                <Image 
                        ...
                        <View style={styles.decideview}>
                            <TouchableOpacity
                                ...
                                onPress={()=>{this.onPressNext()}}
                            >
                                <Text style={styles.txtbnt}> PHCN IKEJA </Text>
                                <Image 
                                    source={require('@assets/images/bills/bank1x.png')}  
                                    style={styles.bntImg} 
                                />
                        ...
                        <View style={styles.decideview}>
                            <TouchableOpacity
                                ...
                                onPress={()=>{this.onPressNext()}}
                            >
                                <Text style={styles.txtbnt}> PHCN KANO </Text>
                                <Image 
                                    source={require('@assets/images/bills/bank1x.png')}  
                                    style={styles.bntImg} 
                                />
                        ...
                        <View style={styles.decideview}>
                            <TouchableOpacity
                                ...
                                onPress={()=>{this.onPressNext()}}
                            >
                                <Text style={styles.txtbnt}> PHCN KADUNA </Text>
                                <Image 
                                    source={require('@assets/images/bills/bank1x.png')}  
                                    style={styles.bntImg} 
                                />
                        ...
                        <View style={styles.decideview}>
                            <TouchableOpacity
                                ...
                                onPress={()=>{this.onPressNext()}}
                            >
                                <Text style={styles.txtbnt}> PHCN JOS </Text>
                                <Image 
                                    source={require('@assets/images/bills/bank1x.png')}  
                                    style={styles.bntImg} 
                                />
                        ...
                        <View style={styles.decideview}>
                            <TouchableOpacity
                                ...
                                onPress={()=>{this.onPressNext()}}
                            >
                                <Text style={styles.txtbnt}> PHCN KOSU </Text>
                                <Image 
                                    source={require('@assets/images/bills/bank1x.png')}  
                                    style={styles.bntImg} 
                                />
