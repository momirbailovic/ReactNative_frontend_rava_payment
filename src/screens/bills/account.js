    ...
    render(){
        ...
        return(
            <ImageBackground source={require('@assets/images/dashboard/bgimage1x.png')} style={styles.backgroundIMG} resizeMode="stretch">
                <ImageBackground source={require('@assets/images/bills/operators1x.png')} style={styles.bgphoneIMG} resizeMode="stretch">
                    <View>
                        <Text style={styles.addtxt}> Account reference </Text>
                    </View>
                </ImageBackground>
                <ScrollView>
                        ...
                        <ImageBackground source={require('@assets/images/withdrawmoney/image1x.png')} style={styles.panelIMG1} resizeMode="stretch">
                            ...
                            <View style={styles.inputtxt1}>
                                <View style={styles.hideView}>
                                    ...
                                    >
                                        <Image source={require('@assets/images/bills/codeee1x.png')} style={styles.mail1x}/>
