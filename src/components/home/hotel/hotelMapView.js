...
class HotelMapViewC extends PureComponent {
    constructor(props) {
        ...
        this.props.actions.searchMap(Global.searchToken)
    }
    ...
    render() {
        ...
        let {mapData, searchPageData} = this.props.hotel
        let currency = 'SAR'
        if(searchPageData.request){
            console.log('searchPageData.request.filtersIndex', searchPageData.request.filtersIndex)
            currency = searchPageData.request.filtersIndex[0].item.filter(o=>o.name=='currency')[0].defaultValue
        }
        ...
        return (
            <View style={styles.container}>
                ...
                >
                    ...
                    >
                        <FontAwesome name="map-marker" size={40} color={Color.pink} />
                    </MapView.Marker>}
                </MapView>}
                <View style={styles.bottomContainer}>
                    <View style={styles.content}>
                        {mapData && mapData[current] && <HotelItem
                            ...
                            // before={mapData[current].imageUrl}
